...
public final class ExtractedImage {
	...
	public ExtractedImage(@JsonProperty("data") byte[] data, @JsonProperty("format") String format,
			@JsonProperty("image_index") int imageIndex, @JsonProperty("page_number") Integer pageNumber,
	...
	public boolean equals(Object obj) {
		...
		return imageIndex == other.imageIndex && mask == other.mask && Arrays.equals(data, other.data)
				&& Objects.equals(format, other.format) && Objects.equals(pageNumber, other.pageNumber)
