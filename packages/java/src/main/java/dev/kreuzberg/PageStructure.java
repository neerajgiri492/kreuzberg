 ...
 *
 * <p>
 * Includes total count, unit type, byte offset boundaries for each page, and
...
public final class PageStructure {
	 ...
	 *
	 * <p>
	 * Maps byte ranges in the extracted content to page numbers. Used for
	 * calculating which pages a chunk spans.
	 *
